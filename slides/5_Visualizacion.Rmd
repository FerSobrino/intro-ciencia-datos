...
- Snow tenía la teoría de que el agua transmitía la enfermedad, pero no podía demostrarlo
...
- La gráfica encontró la fuente del cólera
:::
:::::
...
\begin{center}
\includegraphics[height=0.78\textheight,keepaspectratio]{../images/USCongress.png}
\end{center}
...
- **Explicar**: comunicar un hallazgo a alguien que no vio todas las películas (Disney)
- **Preguntar**: casi siempre una buena gráfica genera más preguntas
...
| ¿Cómo se mueven juntas estas dos? (**relación**) | dispersión, mapa de calor |
| ¿Cuál grupo tiene más? (**comparación**) | barras, boxplot por grupo |
| ¿Cómo cambió esto en el tiempo? (**evolución**) | línea, área |
| ¿De qué está hecho el total? (**composición**) | barras apiladas, cascada, árbol |

\normalsize

- Primero escribe la pregunta; después elige la gráfica. Nunca al revés
...
## Cada propiedad visual carga información

- **Color** (`hue`) para categorías o para una escala continua — nunca las dos cosas a la vez
...
- Si una propiedad visual no codifica nada, quítala

## Trampas técnicas (las veremos en vivo)
...
3. **Facets no son subplots:** un *facet* divide los mismos datos por una variable, con ejes compartidos y comparable por construcción. Un *subplot* son lienzos independientes que pueden venir de bases y escalas distintas — pero el lector los va a comparar de todos modos. Si se comparan ponlo en el título. 
...
- La altura no representa el número
...
\begin{center}
\includegraphics[height=2.9cm]{../images/election_map_2012.png}\hspace{1em}
...
## Qué verificar cuando el agente grafique por ti
...
6. **¿La afirmación del texto es la que muestra la gráfica?** El agente escribe conclusiones seguras; contrástalas contra los ejes, no con el texto 
