...
- Semanas 1–4: Datos — `pandas`, datos limpios (tidy), EDA, **verificación de análisis con IA**
- Semanas 5–6: Visualización — *Examen 1 (semana 6)*
- Semanas 7–9: Aprendizaje supervisado — teoría, `sklearn`, métricas
- Semanas 10–11: Aprendizaje no supervisado (clustering) — *Examen 2 (semana 11)*
- Semana 12: Defensas finales y flujo de trabajo con agentes

## Evaluación

| Componente | Peso |
|---|---|
| Tareas (8, IA permitida con transcripción; se elimina la más baja) | 25% |
| Defensas orales (2 por estudiante, 10 min) | 20% |
| Exámenes en clase (2, escritos, sin computadora) | 35% |
| Ejercicios "Critica a la IA" (4, cuentan 3) | 15% |
| Participación | 5% |
...
- En **exámenes y defensas**: sin IA
  ...
  - En la defensa explicas *tu* tarea y la modificas en vivo
- Eres responsable de todo lo que entregas: "lo escribió el agente" no es defensa

## Defensas orales: qué esperar

- Dos veces en el semestre, 10 minutos
- Yo elijo cuál de tus tareas defiendes
- Explicas tu código, justificas decisiones, haces una modificación pequeña en vivo
- El mejor entrenamiento: antes de entregar, pregúntate *"¿puedo defender esto?"*
